...
## Documentation can be found at [```docs```](https://github.com/cs207-f18-WIRS/cs207-FinalProject/tree/master/docs):
  ...
  - [```docs/Demo and Presentation Project CS207.ipynb:```](https://github.com/cs207-f18-WIRS/cs207-FinalProject/blob/master/docs/Demo and Presentation Project CS207.ipynb) Automatic Differentiation package demo and final presentation.
